...
import com.toeic.subscription.service.PaymentTransactionService;
...
/**
 * REST controller for managing {@link com.toeic.subscription.domain.PaymentTransaction}.
 */
@RestController
...
public class PaymentTransactionResource {
    ...
    private static final String ENTITY_NAME = "subscriptionservicePaymentTransaction";
    ...
    /**
     * {@code GET  /payment-transactions} : get all the Payment Transactions.
     *
