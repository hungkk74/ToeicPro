package com.toeic.subscription.aop.logging;
...
public class LoggingAspect {
    ...
    @Pointcut(
        """
        within(com.toeic.subscription.repository..*)
        || within(com.toeic.subscription.service..*)
        || within(com.toeic.subscription.web.rest..*)
        """
    )
