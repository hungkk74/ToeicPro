...
import static com.toeic.user.web.rest.TestUtil.createUpdateProxyForBean;
...
class UserProfileResourceIT {
    ...
    void putExistingUserProfile() throws Exception {
        ...
        updatedUserProfile.userId(UPDATED_USER_ID).name(UPDATED_NAME).email(UPDATED_EMAIL).phone(UPDATED_PHONE).address(UPDATED_ADDRESS);
    ...
    void partialUpdateUserProfileWithPatch() throws Exception {
        ...
        partialUpdatedUserProfile.userId(UPDATED_USER_ID).name(UPDATED_NAME).address(UPDATED_ADDRESS);
