...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer(javax.cache.configuration.Configuration<Object, Object> jcacheConfiguration) {
        return cm -> {
            createCache(cm, com.toeic.notification.domain.Notification.class.getName(), jcacheConfiguration);
            createCache(cm, com.toeic.notification.domain.NotificationTemplate.class.getName(), jcacheConfiguration);
            createCache(cm, com.toeic.notification.domain.NotificationLog.class.getName(), jcacheConfiguration);
