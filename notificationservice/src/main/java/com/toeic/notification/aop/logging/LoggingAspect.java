package com.toeic.notification.aop.logging;
...
public class LoggingAspect {
    ...
    @Pointcut(
        """
        within(com.toeic.notification.repository..*)
        || within(com.toeic.notification.service..*)
        || within(com.toeic.notification.web.rest..*)
        """
    )
