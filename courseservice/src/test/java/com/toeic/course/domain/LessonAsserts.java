...
public class LessonAsserts {
    ...
    public static void assertLessonUpdatableFieldsEquals(Lesson expected, Lesson actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getLessonType()).as("check lessonType").isEqualTo(expected.getLessonType()))
            ...
            .satisfies(a -> assertThat(a.getIsFreePreview()).as("check isFreePreview").isEqualTo(expected.getIsFreePreview()))
