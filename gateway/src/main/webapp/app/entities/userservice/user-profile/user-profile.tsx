...
export const UserProfile = () => {
  ...
  const userProfileList = useAppSelector(state => state.gateway.userProfile.entities);
  const loading = useAppSelector(state => state.gateway.userProfile.loading);
  const totalItems = useAppSelector(state => state.gateway.userProfile.totalItems);
  ...
  return (
    <div>
      <h2 id="user-profile-heading" data-cy="UserProfileHeading">
        <Translate contentKey="gatewayApp.userserviceUserProfile.home.title">User Profiles</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" variant="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="gatewayApp.userserviceUserProfile.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/user-profile/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="gatewayApp.userserviceUserProfile.home.createLabel">Create new User Profile</Translate>
          </Link>
        </div>
      </h2>
        ...
        {userProfileList?.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="gatewayApp.userserviceUserProfile.id">ID</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="gatewayApp.userserviceUserProfile.home.notFound">No User Profiles found</Translate>
            </div>
          )
        )}
      </div>
