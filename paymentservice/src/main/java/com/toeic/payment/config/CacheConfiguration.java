...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer(javax.cache.configuration.Configuration<Object, Object> jcacheConfiguration) {
        return cm -> {
            createCache(cm, com.toeic.payment.domain.PaymentTransaction.class.getName(), jcacheConfiguration);
            createCache(cm, com.toeic.payment.domain.PaymentWebhookLog.class.getName(), jcacheConfiguration);
